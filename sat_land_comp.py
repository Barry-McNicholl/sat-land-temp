...
def main():
    ...
    #        print('Invalid year. Please enter a year between 1979 and last'
    #              + 'year.')
    # year = str(year)
    ...
    for i in range(len(regions)): # For each region
        ...
        year_land = []
        # Initialise list of satellite cloud cover for each year
        year_cloud = []
        for j in range(len(data_year)): # For every year
            ...
            satmonthtemp = []
            # Initialise satellite monthly cloud cover values
            satmonthcloud = []
